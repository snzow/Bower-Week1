...
public class LinkedIntList implements LinkedIntListInterface{
    ...
    public void removeDuplicates(){
        ...
        int dataToCheck = front.data;
        ListNode toCheck = front;

        while( toCheck.next != null){
            if (toCheck.next.data == toCheck.data){
    ...
    public int deleteBack(){
        ...
        int toReturn = toCheck.data;
        if (toCheck.next == null){
            front = null;
        }
        else{
            ListNode current = toCheck;
            ListNode last = null;
            while (toCheck.next != null){
                toReturn = toCheck.next.data;
                last = toCheck;
                toCheck = toCheck.next;
    ...
    public static class ListNode {
        ...
        public ListNode __gotoNext(boolean checkForCycle) {
            if (checkForCycle) {
                ...
                if (next != null) {
                    if (next.visited) {
                        // throw new IllegalStateException("cycle detected in ist");
                        next.cycle = true;
                    }
                    next.visited = true;
                }
